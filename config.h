...
static const char col_gray3[]       = "#fdf5e6";
static const char col_gray4[]       = "#FA4934";
static const char col_cyan[]        = "#282828"; // #363636";
...
static const int same_color_for_active_window = 1;
/* systray */
...
/*tt  class               instance  title    tags       isfloating  isterminal   noswallow  monitor    widht height */
	...
	{ "Anki",             NULL,     NULL,    1 << 3,    1,          0,           1,         -1, 		800,  600 	},
	{ "Spotify",          NULL,     NULL,    1 << 8,    0,          0,           1,         -1, 		1280, 1024 	},
	{ "gnome-calculator", NULL,     NULL,    0,         1,          0,           1,         -1, 		644,  503 	},
	{ "Google-chrome",    NULL,     NULL,    1 << 0,    0,          0,           1,         -1, 		644,  503 	},
	{ "Emacs",            NULL,     NULL,    1 << 1,    0,          0,           1,         -1, 		1280, 1024 	},
	{ "Evince",           NULL,     NULL,    1 << 2,    0,          0,           1,         -1, 		1280, 1024 	},
...
static const char *run_emacs[] = { "emacs", NULL };
// static const char *run_emacs_client[] = { "emacsclient", "--alternate-editor=", "--create-frame", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY, 	         			XK_F2,                    spawn, {.v = run_emacs } },
	{ MODKEY, 	         			XK_F3,                    spawn, {.v = run_spotify } },
	{ MODKEY, 	         			XK_F4,                    spawn, {.v = run_chrome_incognito } },
